...
KNSaoStyle::KNSaoStyle() :
    QCommonStyle(),
    m_slideLeft(QPixmap("://image/public/left_arrow.png")),
    m_slideRight(QPixmap("://image/public/right_arrow.png")),
    m_slideUp(QPixmap("://image/public/top_arrow.png")),
    m_slideDown(QPixmap("://image/public/down_arrow.png")),
