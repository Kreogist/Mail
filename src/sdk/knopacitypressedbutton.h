...
#ifndef KNOPACITYPRESSEDBUTTON_H
#define KNOPACITYPRESSEDBUTTON_H
 ...
 */
class KNOpacityPressedButton : public QAbstractButton
{
    Q_OBJECT
public:
    /*!
     ...
     */
    explicit KNOpacityPressedButton(QWidget *parent = 0);
...
#endif // KNOPACITYPRESSEDBUTTON_H
