...
#include "kmmailcomponentcontentbase.h"

#define ShadowHeight 18

KMMailComponentContentBase::KMMailComponentContentBase(QWidget *parent) :
    QWidget(parent),
...
void KMMailComponentContentBase::resizeEvent(QResizeEvent *event)
{
    //Resize the widget.
