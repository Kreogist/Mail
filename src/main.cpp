 ...
 */
#include "kmmainwindow.h" //Main window.
#include "knsingletonapplication.h" //Singleton application

#include "core/kmpluginmanager.h" //Plugin Manager.

int main(int argc, char *argv[])
{
    //Create a singleton pattern application.
    KNSingletonApplication app(argc, argv, "org.kreogist.mail");
    ...
    QObject::connect(&app, &KNSingletonApplication::messageAvailable,
                     &pluginManager,
                     &KMPluginManager::onActionArgumentsAvaliable,
                     Qt::QueuedConnection);
